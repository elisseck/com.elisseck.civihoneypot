<div class="crm-block crm-form-block crm-miscellaneous-form-block">
  ...
  <table class="form-layout">
    <tbody>
      <tr>
        <td class="label">{$form.honeypot_form_ids.label}</td>
        <td class="content">{$form.honeypot_form_ids.html}
      ...
      <tr>
        <td class="label">{$form.honeypot_protect_all.label}</td>
        <td class="content">{$form.honeypot_protect_all.html}
      ...
      <tr>
        <td class="label">{$form.honeypot_event_ids.label}</td>
        <td class="content">{$form.honeypot_event_ids.html}
      ...
      <tr>
        <td class="label">{$form.honeypot_protect_all_events.label}</td>
        <td class="content">{$form.honeypot_protect_all_events.html}
      ...
      <tr>
        <td class="label">{$form.honeypot_field_names.label}</td>
        <td class="content">{$form.honeypot_field_names.html}
	  ...
	  <tr>
        <td class="label">{$form.honeypot_limit.label}</td>
        <td class="content">{$form.honeypot_limit.html}
	  ...
	  <tr>
        <td class="label">{$form.honeypot_ipban.label}</td>
        <td class="content">{$form.honeypot_ipban.html}
